...
module.exports = class SuggestCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    if (!sug) return message.channel.send('No suggestion given, please try again. (e.g. ?suggest suggestion)')
    ...
    message.channel.send(Embed).then(sentmsg => sentmsg.react('⬆️')).then(reaction => reaction.message.react('⬇️'));
  }
}